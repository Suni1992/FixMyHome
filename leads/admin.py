...
class LeadAdmin(admin.ModelAdmin):
    ...
    def whatsapp_customer(self, obj):
        ...
        msg = (
            ...
            f"> ────────────────────────\n"
            f font-weight: bold;> नमस्ते *{obj.name}*,\n"
            f"> FixMyHome पर अपनी लीड दर्ज कराने के लिए आपका धन्यवाद।\n"
            f"> ────────────────────────\n"
            f font-weight: bold;> \U0001F6E0 *सर्विस:* {obj.service_type or 'Home Service'}\n"
            f font-weight: bold;> \U0001F4CD *एरिया:* {obj.area or 'Gorakhpur'}\n"
            f"> ────────────────────────\n"
            f font-weight: bold;> \U0001F4F1 *लाइव बुकिंग स्टेटस और कार्ड देखें:*\n"
            f"> {live_card_url}\n"
            f"> ────────────────────────\n"
